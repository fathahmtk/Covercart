...
const About: React.FC = () => {
  return (
    <section id="about" className="py-24 bg-[--color-bg-secondary]">
      <div className="container mx-auto px-6">
        <AnimateOnScroll className="fade-in-up">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2">
              <h2 className="text-4xl font-bold mb-4 text-[--color-text-primary] tracking-tight">About {BUSINESS_INFO.name}</h2>
              <p className="text-[--color-text-secondary] mb-4 leading-relaxed">
                Based in the heart of {BUSINESS_INFO.address}, {BUSINESS_INFO.name} was born from a passion for technology and personal expression. We believe that a phone case is more than just protection; it's a statement piece, a canvas for your personality.
              </p>
