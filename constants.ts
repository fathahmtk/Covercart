...
export const MOCK_PRODUCTS: Product[] = [
    { 
      ...
      imageUrl: 'https://images.unsplash.com/photo-1528722828814-77b9b83aafb2?q=80&w=800&auto=format&fit=crop', 
      category: 'Samsung',
      brand: 'Samsung',
      variants: [
        ...
        { id: 102, name: 'Galaxy Black', imageUrl: 'https://images.unsplash.com/photo-1538949884928-c8a3c85c494d?q=80&w=800&auto=format&fit=crop', colorCode: '#1a202c', stock: 0 },
    ...
    { 
      id: 2, 
      name: 'Marble Elegance Case for iPhone 15 Pro', 
      price: 549, 
    ...
    { id: 6, name: 'Stealth Carbon Case for iPhone 15', price: 599, description: 'A sleek and durable carbon fiber design for a modern, high-tech aesthetic. Premium protection for your Apple iPhone.', imageUrl: 'https://images.unsplash.com/photo-1599582301353-53303c621122?q=80&w=800&auto=format&fit=crop', category: 'Apple', brand: 'Apple', stock: 18 },
    { id: 7, name: 'Ocean Waves Case for Galaxy S24 Ultra', price: 519, description: 'Calming and beautiful depiction of swirling ocean waves in shades of blue. A perfect phone case for your Samsung Galaxy.', imageUrl: 'https://images.unsplash.com/photo-1507904398114-6d8b6ca28a07?q=80&w=800&auto=format&fit=crop', category: 'Samsung', brand: 'Samsung', stock: 3, isFeatured: true },
    { id: 8, name: 'Gamer Grid Case for Pixel 8 Pro', price: 499, description: 'A neon grid pattern perfect for gamers, glowing with electric energy. Light up your Google Pixel.', imageUrl: 'https://images.unsplash.com/photo-1603366615917-e213e0941bbd?q=80&w=800&auto=format&fit=crop', category: 'Google', brand: 'Google', stock: 25, isFeatured: true },
    ...
    { id: 10, name: 'Wild Leopard Case for Redmi Note 13', price: 539, description: 'A chic and trendy leopard print pattern for a bold fashion statement on your Xiaomi phone.', imageUrl: 'https://images.unsplash.com/photo-1611252391258-393f9b3e1577?q=80&w=800&auto=format&fit=crop', category: 'Xiaomi', brand: 'Xiaomi', stock: 9 },
