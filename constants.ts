...
export const MOCK_PRODUCTS: Product[] = [
    ...
    { id: 8, name: 'Gamer Grid Case for Pixel 8 Pro', price: 499, description: 'A neon grid pattern perfect for gamers, glowing with electric energy. Light up your Google Pixel.', imageUrl: 'https://images.unsplash.com/photo-1603366615917-e213e0941bbd?q=80&w=800&auto=format&fit=crop', category: 'Google', brand: 'Google', stock: 25 },
